...
#define SUPPORTS_GD_2_3_2 (GD_MINOR_VERSION == 3 && GD_RELEASE_VERSION >= 2)

#define SUPPORTS_GD_2_3_0 (GD_MINOR_VERSION == 3 && GD_RELEASE_VERSION >= 0)
...
#define REQ_STR_ARG(I, VAR, MSG)                                   \
  ...
  {                                                                \
    Napi::TypeError::New(info.Env(),                               \
                         "Argument " #I " must be a string. " MSG) \
        .ThrowAsJavaScriptException();                             \
    return info.Env().Null();                                      \
  }                                                                \
...
#define OPT_INT_ARG(I, VAR, DEFAULT)                                  \
  ...
  {                                                                   \
    Napi::TypeError::New(info.Env(),                                  \
                         "Optional argument " #I " must be a Number") \
        .ThrowAsJavaScriptException();                                \
    return info.Env().Null();                                         \
  }
